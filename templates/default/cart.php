                    ...
                    <section class="catalog-section catalog-section__line">
                        ...
                        <div class="basket-top">
                            ...
                            <div class="total-basket-price">
                                Итого:
                                <span class="total-basket-price_old-price" data-totalOldSum><?= $this->cart['total_old_sum'] ?? '' ?></span>
                                <span class="total-basket-price_new-price" data-totalSum><?= $this->cart['total_sum']?></span>
                            </div>
            ...
            <div class="container">
                <form class="order-registration-form">
                    ...
                    <div class="amount-pay-wrapp">
                        Сумма к оплате:
                        <span class="amount-pay" data-totalSum><?= $this->cart['total-sum']?></span>
                    </div>
