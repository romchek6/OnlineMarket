    ...
    <section class="offers">
        <div class="offers__tabs">
            ...
            <?php foreach ($arrHits as $key => $value): ?>
                <?php  if(!empty($goods[$key])):?>
                    <div class="offers__tabs_content <?= !++$active?'active':''?>">
    ...
    <div class="horizontal__wrapper">
        <section class="about">
            <div class="about__description">
                <div class="about__description_name subheader"><?= $this->set['promo_name'] ?></div>
            ...
            <div class="about__image">
                <img src="<?= $this->img($this->set['promo_img']) ?>" alt="<?= $this->set['promo_name'] ?>">
            </div>
        </section>
